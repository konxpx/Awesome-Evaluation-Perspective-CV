...
- [Visual Capability - Clarifying the Evaluation Goals](#visual-capability-clarifying-the-evaluation-goals)

- [Proxy Task - Defining the Scope of Evaluation](#proxy-task-defining-the-scope-of-evaluation)

- [Data Environment - Providing the Platform for Evaluation](#data-environment-providing-the-platform-for-evaluation)

- [Evaluation System - Establishing Evaluation Standards](#evaluation-system-establishing-evaluation-standards)

- [Evaluation Models - Analyzing the Subject of Evaluation](#evaluation-models-analyzing-the-subject-of-evaluation)
...
##### `Biologically Inspired Visual Capabilities`
...
##### `Cognitive Science Inspiration in Computer Vision`
...
#### `Data Environment - Providing the Platform for Evaluation`
...
#### `Evaluation System - Establishing Evaluation Standards`
...
##### `Algorithms in The Era of Large Models`
